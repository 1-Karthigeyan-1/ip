...
public class Save {
        ...
        while (storageData.hasNext()) {
            ...
            switch(arguments[0]) {
                case "T":
                    ...
                    Tasks[i] = new Todo(arguments[2]);
                    break;
                case "E":
                    Tasks[i] = new Event(arguments[2], arguments[3]);
                    break;
                case "D":
                    Tasks[i] = new Deadline(arguments[2], arguments[3]);
                    break;
                default:
    ...
    public static void writeFile(Task[] Tasks) throws IOException {
